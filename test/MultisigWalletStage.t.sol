...
contract MultisigWalletStageTest is Test {
    ...
    function setUp() public {
        // Initialize owner addresses from environment variables
        owner1 = vm.envAddress("OWNER1_ADDRESS");
        owner2 = vm.envAddress("OWNER2_ADDRESS");
        owner3 = vm.envAddress("OWNER3_ADDRESS");
        owner4 = vm.envAddress("OWNER4_ADDRESS");
        owner5 = vm.envAddress("OWNER5_ADDRESS");
        nonOwner = address(1000);

        // Connect to the deployed MultisigWallet
        multisigWallet = MultisigWallet(
            payable(0x205750B139d821A87caBD52757be99DC92FF07D0)
        );

        // Initialize token contracts if applicable
        erc20Token = SimpleERC20(0xbD89C92329E24a6abdE36e3aa44F17B396d62422);
        erc721Token = SimpleERC721(0x76590a96a63688Ad1c7422fbAa6EFB66C9ba176a);
    }
